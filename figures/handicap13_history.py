...
if __name__ == "__main__":
    ...
    plt.plot(list(map(lambda x: x.mu, handicap_history[(2,13)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(3,13)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(4,13)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(5,13)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(6,13)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(7,13)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(8,13)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(9,13)] )) )
