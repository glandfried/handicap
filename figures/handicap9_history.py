...
if __name__ == "__main__":
    ...
    plt.plot(list(map(lambda x: x.mu, handicap_history[(2,9)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(3,9)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(4,9)] )) )
    plt.plot(list(map(lambda x: x.mu, handicap_history[(5,9)] )) )
