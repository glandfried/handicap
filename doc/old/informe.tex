...
% experimentamos sobre ogs y kgs (y eventualmente AAGo)
...
% calcular la probabilidad de un modelo y del otro?
% cuando calcule la probabilidad del modelo con la evidencia de kgs vamos a tener dos indicadores, los podemos poner por separado, pero sería interesante agregarlos en un solo indicador (es decir, la probabilidad del modelo dada toda la evidencia que tenemos, la de kgs Y la de ogs). cómo sería?
% ambos tienen distintos gamma optimos, habría que calcular el gamma optimo para la combinacion?
